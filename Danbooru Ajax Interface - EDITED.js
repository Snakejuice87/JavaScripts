// ==UserScript==
// @name           Danbooru Ajax Interface - EDITED
...
var tags = "", images = 10, page = 1, rating = "s", sampleRate = 1, blacklist = "spoilers \nguro \nscat \nfuta_on_futa \nfuta_on_male \nmale_sucking_futa \nfuta_only \nmale_focus ";
...
dai_css.appendChild(d.createTextNode("body { margin: 4px; } a { text-decoration: none; color: #0000EE; } img { border: 0px; } .thumb { border: 1px solid WhiteSmoke; min-width: 150px; min-height: 150px; max-width: 150px; max-height: 150px; margin: -1px 0px 0px -1px; padding: 1px; display: flex; justify-content: center; align-items: center; font-size: small; overflow: hidden; } .yellow { background-color: LightYellow; } .red { background-color: MistyRose; } .trans { border: 1px solid Black; background-color: LightYellow; position: absolute; } *:not(body) { transition: all 1s ease-in-out 0s; }"));
...
if(cacheTags.length == 0) {
    popularTags = "touhou younger kantai_collection loli bestiality".split(" ").reverse();

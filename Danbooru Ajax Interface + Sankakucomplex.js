// ==UserScript==
// @name            Danbooru Ajax Interface + Sankakucomplex
...
var sites = [
    ...
    /*
        {
        name    :   "chan.Sankakucomplex.com",                                 // Site name
        site    :   "chan\.sankakucomplex\.",                               // Regular expression check on current url
        post    :   "/posts.xml",                               // Relative url to xml post API
        note    :   "/notes.xml",                               // Relative url to xml note API
        list    :   "/posts/",                                  // Relative url to post listing
        page    :   "/posts/",                                  // Relative url to post page
...
var tags = "", images = 30, page = 1, rating = "e", sampleRate = 1, blacklist = "spoilers \nguro \nscat \nfuta_on_futa \nfuta_on_male \nmale_sucking_futa \nfuta_only \nmale_focus ";

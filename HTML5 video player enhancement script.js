...
/*!
 * @name         original.js
 * @description  Store some important native functions to prevent external contamination. This logic should be pre-positioned as much as possible, otherwise it will be stored as a contaminated function.
 * @version      0.0.1
 * @author       xxxily
...
const defConfig = {
  ...
  enhance: {
    /* If the default speed regulation logic is not disabled, the speed can be easily reset when switching multiple videos, so this option is turned on by default.*/

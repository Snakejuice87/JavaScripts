// ==UserScript==
// @author      Snakejuice
// @name        Pornhub extended
// @description button to toggle mute & shit
// @include     *pornhub.com/*
...
$('. element'). on('mouseover mouseenter mouseleave mouseup mousedown', function() { return false });

document.getElementsByTagName('video')[0].removeAttribute('muted');
